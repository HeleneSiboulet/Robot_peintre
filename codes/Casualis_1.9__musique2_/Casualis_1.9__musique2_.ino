...
int wait=750; // temps d'attente apres une note (il peux definir le temps de la note)
int fin=3;
...
int dureNote=750;// ≠ de wait il definit le temps pendant lequel sera jouée au max
